...
public:
  ...
  ClientHandler(BlockingQueue<Message>* pQ, const std::string& const rcvPath, const std::string& name = "clientHandler") 
      : pQ_(pQ), saveFilePath(rcvPath) ,clientHandlerName(name)
  {
